...
;;klang@endjinn:~$ curl "http://localhost:10000/test/greet/klang"
;;klang@endjinn:~$ curl "http://localhost:10000/judge/creds?username=klang&password=secret"
